...
public class Int101Homework02Updated {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to 
        ...
        //test 1.2 testString
        System.out.println(Utilitor.testString("1.2 Love Ajarn Kriengkrai And P.TA Mak Mak"));
        // test 1.2 if String is null or blank
        try {
            System.out.print("1.2 If input is Null or blank : ");
        //   Utilitor.testString(null);
             Utilitor.testString("  ");
        }
        ...
        //test 1.3 testPositive
        System.out.println("1.3 test positive : "+ Utilitor.testPositive(5));
        //test 1.3 if not positive
        try {
            System.out.print("1.3 If input is -1 : ");
        ...
        //test 1.4 computeIsbn10
        System.out.println("1.4 Test Isbn10 974472362 = "+ Utilitor.computeIsbn10(974472362));
        // test 1.4 if digit is more than 9
        try {
            System.out.print("1.4 If input is 10 digit : ");
            System.out.println(Utilitor.computeIsbn10(1123456789));
        }
        catch (IllegalArgumentException e){
            System.out.println("Digit is moere than 9 >:C ");
        }
    }
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        System.out.println("===== Work02 =====");
         // test 2.2 - 2.6 Field and Constructor
        Person p1 = new Person("Fei", "Sucahi");
        Person p2 = new Person("Oshimi","Naruedom");

        // test 2.7 toString
        System.out.println("2.7 p1 = "+ p1);
        System.out.println("2.7 p2 = "+ p2);

        // test 2.8 getter
        System.out.println("===== getter & setter =====");
        System.out.println("2.8 getter p1 id :"+p1.getId());
        System.out.println("2.8 getter p1 fistname :"+p1.getFirstname());
        System.out.println("2.8 getter p1 lastname :"+p1.getLastname());
        // test 2.9 setter
        System.out.println("2.9 p1 firstname Before : "+p1.getFirstname());
        p1.setFirstname("somchai");
        System.out.println("2.9 p1 firstname After : "+p1.getFirstname());
        // test 2.9 if input is null
        try {
            System.out.print("2.9 If setter input is Null or blank : ");
        ...
        // test 2.10 equals
        System.out.println("2.10 p1 equals p1? :"+ p1.equals(p1));
        System.out.println("2.10 p1 equals p2? : "+p1.equals(p2));
    }
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to
        ...
        Person p3 = new Person("Somchok", "LoveCompro");
        Person p4 = new Person("Somchai","HateCompro");
        Person p5 = new Person("Pita", "LimChaRon");
        Person p6 = new Person("Prayut","ChanAngKhan");
        // Create Peson Object
        System.out.println("Create Person3! "+ p3);  // person 1-2 has already made by previous method
        System.out.println("Create Person4! "+ p4);
        System.out.println("Create Person5! "+ p5);
        System.out.println("Create Person6! "+ p6);
        // 3.2 - 3.6 Test Field and Constructor
        Account account1 = new Account(p3);
        Account account2 = new Account(p4);
        Account account3 = new Account(p5);
        Account account4 = new Account(p6);
        // check account By toString
        System.out.println("3.2 - 3.6 test account : "+account1);
        System.out.println("3.2 - 3.6 test account : "+account2);
        System.out.println("3.2 - 3.6 test account : "+account3);
        System.out.println("3.2 - 3.6 test account : "+account4);

        // 3.7 Test getter
        System.out.println("===== Getter =====");
        System.out.println("3.7 Account1 No :"+account1.getNo());
        System.out.println("3.7 Account1 Balance :"+account1.getBalance());
        System.out.println("3.7 Account1 Owner : "+account1.getOwner());

        // 3.8 test deposit
        System.out.println("===== Deposit & withdraw =====");
        System.out.println("3.8 account1 Before deposit : "+account1.getBalance());

        System.out.println("3.8 account1 After deposit : "+account1.deposit(1500));
        // test 3.8 if amount is not positive
        try {
            System.out.print("3.8 if amount is not positive : ");
            System.out.println(account1.deposit(-500));
        }
        catch (IllegalArgumentException e){
            System.out.println("Deposit fail - amount is not positive");
        }

        // 3.9 test withdraw
        System.out.println("3.9 account1 After withdraw 500 Current = "+account1.withdraw(500));
        // test 3.9 if amount not positive or more than balance
        try {
            System.out.print("3.9 if amount not positive or more than balance : ");
        // Current balance is 1500
            ...
            System.out.println("Withdraw fail - amount is not positive or more than balance");
        }
        // 3.10 test tranfer
        System.out.println("===== tranfer =====");
        // Before
        System.out.println("3.10 account1 current balance : "+account1.getBalance());
        System.out.println("3.10 account2 current balance : "+account2.getBalance());
        // Tranfer
        System.out.println("account1 tranfer to account2 300 ");
        account1.tranfer(300, account2);
        // After
        System.out.println("3.10 account1 current balance : "+account1.getBalance());
        System.out.println("3.10 account2 current balance : "+account2.getBalance());
        // If transfer to self Account
        try {
            System.out.print("3.10 If tranfer to the same Account : ");
            account1.tranfer(100,account1);
            System.out.println(account1.getBalance());
        }
        catch (IllegalArgumentException e){
            System.out.println("Tranfer fail - cannot tranfer to the same account");
        }
        // 3.11 test toString
        System.out.println("===== equals & toString =====");
        System.out.println("3.11 account1 = "+ account1);
        System.out.println("3.11 account2 = "+ account2);

        // 3.12 test equal
        System.out.println("3.12 account1 equals account1 : "+account1.equals(account1));
        System.out.println("3.12 account1 equals account2 : "+account1.equals(account2));
